...
func _ready() -> void:
	global_position = Vector2(1280.0, 398.0)
	var tween = get_tree().create_tween()
	tween.tween_property(self, "global_position", Vector2(1072.0, 398.0), 1)
	...
	tween.tween_property(self, "global_position", Vector2(1280.0, 398.0), 1)
	tween.play()
	await tween.finished
	queue_free()
